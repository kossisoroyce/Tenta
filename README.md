...
Production inference is served through [Timber](https://github.com/kossisoroyce/timber), an AOT compiler that turns XGBoost, LightGBM, scikit-learn, CatBoost, and ONNX fraud models into signed, dependency-free C99 artifacts. Timber gives the scoring runtime the p99 latency budget, the deterministic behavior, and the artifact provenance that this platform's safety and audit story depends on.
...
- [Timber Compiler Integration](docs/architecture/03a-timber-compiler.md)
